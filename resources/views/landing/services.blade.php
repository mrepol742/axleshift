<div class="container-fluid h-100">
    <div class="row h-100 justify-content-center align-items-center p-5">
        <div class="col-12 col-lg-5 order-md-1 mb-4">
            <span data-aos="fade-up">OUR SERVICES</span>
            <h1 class="text-primary" data-aos="fade-up">
        ...
        <div class="col-12 col-lg-7 order-md-2 mb-4">
            <div class="row row-cols-1 row-cols-md-2 g-4">
                <div class="col">
                    <div
                        class="mb-2 d-inline-block rounded-pill bg-primary bg-opacity-25 p-3"
                        data-aos="fade-up"
                        data-aos-delay="200">
                        <i class="fa fa-ship fa-2x text-primary" style="width: 40px; height: 40px;"></i>
                    </div>
                ...
                <div class="col">
                    <div
                        ...
                        data-aos="fade-up"
                        data-aos-delay="200">
                        <i class="fa fa-route fa-2x text-primary" style="width: 40px; height: 40px;"></i>
                    </div>
                    <h3 data-aos="fade-up" data-aos-delay="500">
                        AI Powered Route
                    </h3>
                ...
                <div class="col">
                    <div
                        ...
                        data-aos="fade-up"
                        data-aos-delay="200">
                        <i class="fa fa-user fa-2x text-primary" style="width: 40px; height: 40px;"></i>
                    </div>
                    <h3 data-aos="fade-up" data-aos-delay="500">
                ...
                <div class="col">
                    <div
                        ...
                        data-aos="fade-up"
                        data-aos-delay="200">
                        <i class="fa fa-user-shield fa-2x text-primary" style="width: 40px; height: 40px;"></i>
                    </div>
                    <h3 data-aos="fade-up" data-aos-delay="500">
